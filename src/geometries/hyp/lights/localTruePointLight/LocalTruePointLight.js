...
import trueLightIntensity from "../../imports/trueLightIntensity.glsl";
 ...
 * Point light
 */
export class LocalTruePointLight extends Light {
    ...
    constructor(position, color, intensity = 1) {
        ...
        this.addImport(distance, direction, trueLightIntensity);
    }
