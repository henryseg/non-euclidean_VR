...
import {
    bind,
    BasicRenderer, PathTracerRenderer, Scene,
    SphereCamera,PathTracerCamera,
    ExpFog,
    FlyControls
} from "3ds";
...
export class Thurston {
    ...
    constructor(set, params = {}) {
         ...
         * @type {BasicRenderer}
         */
        this.renderer = new BasicRenderer(this.camera, this.scene, {}, this.threeRenderer);
        /**
         * Non-euclidean renderer for path tracer
         * @type {PathTracerRenderer}
         */
        this.ptRenderer = new PathTracerRenderer(this.ptCamera, this.scene, {}, this.threeRenderer);
        /**
