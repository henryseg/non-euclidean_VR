...
/**
 *
 * @param {SphereCamera} camera Virtual camera used in the scene
...
class ArcballControls extends EventDispatcher {
	 ...
	 * @param {SphereCamera} camera The virtual camera to be controlled
	 */
	setCamera( camera ) {
	 ...
	 * @param {SphereCamera} camera Virtual camera
	 ...
	 * @param {SphereCamera} camera The virtual camera
