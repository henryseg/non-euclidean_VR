...
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("RayType ");t.b(t.v(t.f("name",c,p,0)));t.b("_setRayType(ExtVector v, RelVector n,float r) {\r");t.b("\n" + i);t.b("    return setRayType(");t.b(t.v(t.f("name",c,p,0)));t.b(", v, n, r);\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, RayType rayType) {\r");t.b("\n" + i);t.b("    return render(");t.b(t.v(t.f("name",c,p,0)));t.b(", v, rayType);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "RayType {{name}}_setRayType(ExtVector v, RelVector n,float r) {\r\n    return setRayType({{name}}, v, n, r);\r\n}\r\n\r\nvec3 {{name}}_render(ExtVector v, RelVector normal, RayType rayType) {\r\n    return render({{name}}, v, rayType);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    return vec4(0, float(v.data.iMarch/camera.maxSteps), v.data.totalDist / camera.maxDist, 1);\r");t.b("\n" + i);t.b("    //return vec4(debugColor,1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v) {\r\n    return vec4(0, float(v.data.iMarch/camera.maxSteps), v.data.totalDist / camera.maxDist, 1);\r\n    //return vec4(debugColor,1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    HighlightLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v) {\r\n    HighlightLocalWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r\n        return {{highlightMat.name}}_render(v);\r\n    }\r\n    return {{defaultMat.name}}_render(v);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    HighlightLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,0,224,295,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("defaultMat.usesNormal",c,p,1),c,p,0,493,554,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("defaultMat.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    HighlightLocalWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r\n        {{#highlightMat.usesNormal}}\r\n            return {{highlightMat.name}}_render(v, normal);\r\n        {{/highlightMat.usesNormal}}\r\n        {{^highlightMat.usesNormal}}\r\n            return {{highlightMat.name}}_render(v);\r\n        {{/highlightMat.usesNormal}}\r\n    }\r\n\r\n    {{#defaultMat.usesNormal}}\r\n        return {{defaultMat.name}}_render(v, normal);\r\n    {{/defaultMat.usesNormal}}\r\n    {{^defaultMat.usesNormal}}\r\n        return {{defaultMat.name}}_render(v);\r\n    {{/defaultMat.usesNormal}}\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    HighlightLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r");t.b("\n" + i);if(!t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,413,488,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,0,593,901,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,781,864,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(!t.s(t.d("defaultMat.name.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,0,1146,1211,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("    \r");t.b("\n" + i);if(t.s(t.d("defaultMat.name.usesNormal",c,p,1),c,p,0,1321,1609,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,0,1500,1573,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    HighlightLocalWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r\n        {{^highlightMat.usesNormal}}\r\n            {{^highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v);\r\n            {{/highlightMat.usesUVMap}}\r\n            {{#highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, uv);\r\n            {{/highlightMat.usesUVMap}}\r\n        {{/highlightMat.usesNormal}}\r\n\r\n        {{#highlightMat.usesNormal}}\r\n            {{^highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, normal);\r\n            {{/highlightMat.usesUVMap}}\r\n            {{#highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, normal, uv);\r\n            {{/highlightMat.usesUVMap}}\r\n        {{/highlightMat.usesNormal}}\r\n    }\r\n\r\n    {{^defaultMat.name.usesNormal}}\r\n        {{^defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v);\r\n        {{/defaultMat.name.usesUVMap}}\r\n        {{#defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, uv);\r\n        {{/defaultMat.name.usesUVMap}}\r\n    {{/defaultMat.name.usesNormal}}\r\n    \r\n    {{#defaultMat.name.usesNormal}}\r\n        {{^defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, normal);\r\n        {{/defaultMat.name.usesUVMap}}\r\n        {{#defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, normal, uv);\r\n        {{/defaultMat.name.usesUVMap}}\r\n    {{/defaultMat.name.usesNormal}}\r\n}\r\n\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    HighlightLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,214,281,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("defaultMat.usesUVMap",c,p,1),c,p,0,475,532,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("defaultMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, vec2 uv) {\r\n    HighlightLocalWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn && material.cellBoost == v.vector.cellBoost) {\r\n        {{#highlightMat.usesUVMap}}\r\n            return {{highlightMat.name}}_render(v, uv);\r\n        {{/highlightMat.usesUVMap}}\r\n        {{^highlightMat.usesUVMap}}\r\n            return {{highlightMat.name}}_render(v);\r\n        {{/highlightMat.usesUVMap}}\r\n    }\r\n\r\n    {{#defaultMat.usesUVMap}}\r\n        return {{defaultMat.name}}_render(v, uv);\r\n    {{/defaultMat.usesUVMap}}\r\n    {{^defaultMat.usesUVMap}}\r\n        return {{defaultMat.name}}_render(v);\r\n    {{/defaultMat.usesUVMap}}\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    HighlightWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn) {\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v) {\r\n    HighlightWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn) {\r\n        return {{highlightMat.name}}_render(v);\r\n    }\r\n    return {{defaultMat.name}}_render(v);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    HighlightWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn) {\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,0,175,246,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("defaultMat.usesNormal",c,p,1),c,p,0,444,505,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("defaultMat.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    HighlightWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn) {\r\n        {{#highlightMat.usesNormal}}\r\n            return {{highlightMat.name}}_render(v, normal);\r\n        {{/highlightMat.usesNormal}}\r\n        {{^highlightMat.usesNormal}}\r\n            return {{highlightMat.name}}_render(v);\r\n        {{/highlightMat.usesNormal}}\r\n    }\r\n\r\n    {{#defaultMat.usesNormal}}\r\n        return {{defaultMat.name}}_render(v, normal);\r\n    {{/defaultMat.usesNormal}}\r\n    {{^defaultMat.usesNormal}}\r\n        return {{defaultMat.name}}_render(v);\r\n    {{/defaultMat.usesNormal}}\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    HighlightWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn) {\r");t.b("\n" + i);if(!t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,364,439,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesNormal",c,p,1),c,p,0,544,852,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,732,815,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(!t.s(t.d("defaultMat.name.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,0,1097,1162,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("    \r");t.b("\n" + i);if(t.s(t.d("defaultMat.name.usesNormal",c,p,1),c,p,0,1272,1560,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("defaultMat.name.usesUVMap",c,p,1),c,p,0,1451,1524,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    HighlightWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn) {\r\n        {{^highlightMat.usesNormal}}\r\n            {{^highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v);\r\n            {{/highlightMat.usesUVMap}}\r\n            {{#highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, uv);\r\n            {{/highlightMat.usesUVMap}}\r\n        {{/highlightMat.usesNormal}}\r\n\r\n        {{#highlightMat.usesNormal}}\r\n            {{^highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, normal);\r\n            {{/highlightMat.usesUVMap}}\r\n            {{#highlightMat.usesUVMap}}\r\n                return {{highlightMat.name}}_render(v, normal, uv);\r\n            {{/highlightMat.usesUVMap}}\r\n        {{/highlightMat.usesNormal}}\r\n    }\r\n\r\n    {{^defaultMat.name.usesNormal}}\r\n        {{^defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v);\r\n        {{/defaultMat.name.usesUVMap}}\r\n        {{#defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, uv);\r\n        {{/defaultMat.name.usesUVMap}}\r\n    {{/defaultMat.name.usesNormal}}\r\n    \r\n    {{#defaultMat.name.usesNormal}}\r\n        {{^defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, normal);\r\n        {{/defaultMat.name.usesUVMap}}\r\n        {{#defaultMat.name.usesUVMap}}\r\n            return {{defaultMat.name}}_render(v, normal, uv);\r\n        {{/defaultMat.name.usesUVMap}}\r\n    {{/defaultMat.name.usesNormal}}\r\n}\r\n\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    HighlightWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(material.isHighlightOn) {\r");t.b("\n" + i);if(t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,0,165,232,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("highlightMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            return ");t.b(t.v(t.d("highlightMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("defaultMat.usesUVMap",c,p,1),c,p,0,426,483,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("defaultMat.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("        return ");t.b(t.v(t.d("defaultMat.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, vec2 uv) {\r\n    HighlightWrapMaterial material = {{name}};\r\n\r\n    if(material.isHighlightOn) {\r\n        {{#highlightMat.usesUVMap}}\r\n            return {{highlightMat.name}}_render(v, uv);\r\n        {{/highlightMat.usesUVMap}}\r\n        {{^highlightMat.usesUVMap}}\r\n            return {{highlightMat.name}}_render(v);\r\n        {{/highlightMat.usesUVMap}}\r\n    }\r\n\r\n    {{#defaultMat.usesUVMap}}\r\n        return {{defaultMat.name}}_render(v, uv);\r\n    {{/defaultMat.usesUVMap}}\r\n    {{^defaultMat.usesUVMap}}\r\n        return {{defaultMat.name}}_render(v);\r\n    {{/defaultMat.usesUVMap}}\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v).rgb;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, RayType rayType) {\r\n    if (rayType.reflect){\r\n        return {{name}}.specular;\r\n    }\r\n    return {{material.name}}_render(v).rgb;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal).rgb;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, RayType rayType) {\r\n    if (rayType.reflect){\r\n        return {{name}}.specular;\r\n    }\r\n    return {{material.name}}_render(v, normal).rgb;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;   \r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv).rgb;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r\n    if (rayType.reflect){\r\n        return {{name}}.specular;   \r\n    }\r\n    return {{material.name}}_render(v, normal, uv).rgb;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("      return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv).rgb;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r\n    if (rayType.reflect){\r\n      return {{name}}.specular;\r\n    }\r\n    return {{material.name}}_render(v, uv).rgb;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v).rgb;\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,271,605,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return vec4(color, 1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n\r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v).rgb;\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n    \r\n    return vec4(color, 1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal).rgb;\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,279,613,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("    return vec4(color, 1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n\r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, normal).rgb;\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n\r\n    return vec4(color, 1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv).rgb;\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,292,626,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("    return vec4(color, 1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n\r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, normal, uv).rgb;\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n\r\n    return vec4(color, 1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b(" \r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv).rgb;\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,285,619,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("    return vec4(color, 1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n \r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, uv).rgb;\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n\r\n    return vec4(color, 1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b(" \r");t.b("\n" + i);t.b("    PhongMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,213,536,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return vec4(color, 1);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n \r\n    PhongMaterial material = {{name}};\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n    \r\n    return vec4(color, 1);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    vec4 color0, color1;\r");t.b("\n" + i);t.b("    TransitionLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    if(v.vector.cellBoost == material.cellBoost){\r");t.b("\n" + i);t.b("        color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("    } else{\r");t.b("\n" + i);t.b("        color1 = color0;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v) {\r\n    vec4 color0, color1;\r\n    TransitionLocalWrapMaterial material = {{name}};\r\n\r\n    color0 = {{mat0.name}}_render(v);\r\n\r\n    if(v.vector.cellBoost == material.cellBoost){\r\n        color1 = {{mat1.name}}_render(v);\r\n    } else{\r\n        color1 = color0;\r\n    }\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    TransitionLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec4 color0, color1;\r");t.b("\n" + i);if(t.s(t.d("mat0.usesNormal",c,p,1),c,p,0,159,217,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        color0 =  ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat0.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("        color0 =  ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);t.b("    if(v.vector.cellBoost == material.cellBoost){\r");t.b("\n" + i);if(t.s(t.d("mat1.usesNormal",c,p,1),c,p,0,416,482,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            color1 =  ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat1.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("            color1 =  ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    } else {\r");t.b("\n" + i);t.b("        color1 = color0;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    TransitionLocalWrapMaterial material = {{name}};\r\n    vec4 color0, color1;\r\n    {{#mat0.usesNormal}}\r\n        color0 =  {{mat0.name}}_render(v, normal);\r\n    {{/mat0.usesNormal}}\r\n    {{^mat0.usesNormal}}\r\n        color0 =  {{mat0.name}}_render(v);\r\n    {{/mat0.usesNormal}}\r\n\r\n    if(v.vector.cellBoost == material.cellBoost){\r\n        {{#mat1.usesNormal}}\r\n            color1 =  {{mat1.name}}_render(v, normal);\r\n        {{/mat1.usesNormal}}\r\n        {{^mat1.usesNormal}}\r\n            color1 =  {{mat1.name}}_render(v);\r\n        {{/mat1.usesNormal}}\r\n    } else {\r\n        color1 = color0;\r\n    }\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    vec4 color0, color1;\r");t.b("\n" + i);t.b("    TransitionLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(!t.s(t.d("mat0.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,304,365,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("    \r");t.b("\n" + i);if(t.s(t.d("mat0.usesNormal",c,p,1),c,p,0,442,678,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,584,653,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("mat1.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,860,921,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);t.b("    if(v.vector.cellBoost == material.cellBoost){\r");t.b("\n" + i);if(t.s(t.d("mat1.usesNormal",c,p,1),c,p,0,1049,1313,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,1207,1284,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    } else{\r");t.b("\n" + i);t.b("        color1 = color0;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    vec4 color0, color1;\r\n    TransitionLocalWrapMaterial material = {{name}};\r\n\r\n    {{^mat0.usesNormal}}\r\n        {{^mat0.usesUVMap}}\r\n            color0 = {{mat0.name}}_render(v);\r\n        {{/mat0.usesUVMap}}\r\n        {{#mat0.usesUVMap}}\r\n            color0 = {{mat0.name}}_render(v, uv);\r\n        {{/mat0.usesUVMap}}\r\n    {{/mat0.usesNormal}}\r\n    \r\n    {{#mat0.usesNormal}}\r\n        {{^mat0.usesUVMap}}\r\n            color0 = {{mat0.name}}_render(v, normal);\r\n        {{/mat0.usesUVMap}}\r\n        {{#mat0.usesUVMap}}\r\n            color0 = {{mat0.name}}_render(v, normal, uv);\r\n        {{/mat0.usesUVMap}}\r\n    {{/mat0.usesNormal}}\r\n\r\n    {{^mat1.usesNormal}}\r\n        {{^mat1.usesUVMap}}\r\n            color1 = {{mat1.name}}_render(v);\r\n        {{/mat1.usesUVMap}}\r\n        {{#mat1.usesUVMap}}\r\n            color1 = {{mat1.name}}_render(v, uv);\r\n        {{/mat1.usesUVMap}}\r\n    {{/mat1.usesNormal}}\r\n\r\n    if(v.vector.cellBoost == material.cellBoost){\r\n        {{#mat1.usesNormal}}\r\n            {{^mat1.usesUVMap}}\r\n                color1 = {{mat1.name}}_render(v, normal);\r\n            {{/mat1.usesUVMap}}\r\n            {{#mat1.usesUVMap}}\r\n                color1 = {{mat1.name}}_render(v, normal, uv);\r\n            {{/mat1.usesUVMap}}\r\n        {{/mat1.usesNormal}}\r\n    } else{\r\n        color1 = color0;\r\n    }\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    vec4 color0, color1;\r");t.b("\n" + i);t.b("    TransitionLocalWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,151,204,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("        color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);t.b("    if(v.vector.cellBoost == material.cellBoost){\r");t.b("\n" + i);if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,398,459,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("    } else{\r");t.b("\n" + i);t.b("        color1 = color0;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, vec2 uv) {\r\n    vec4 color0, color1;\r\n    TransitionLocalWrapMaterial material = {{name}};\r\n\r\n    {{#mat0.usesUVMap}}\r\n        color0 = {{mat0.name}}_render(v, uv);\r\n    {{/mat0.usesUVMap}}\r\n    {{^mat0.usesUVMap}}\r\n        color0 = {{mat0.name}}_render(v);\r\n    {{/mat0.usesUVMap}}\r\n\r\n    if(v.vector.cellBoost == material.cellBoost){\r\n        {{#mat1.usesUVMap}}\r\n            color1 = {{mat1.name}}_render(v, uv);\r\n        {{/mat1.usesUVMap}}\r\n        {{^mat1.usesUVMap}}\r\n            color1 = {{mat1.name}}_render(v);\r\n        {{/mat1.usesUVMap}}\r\n    } else{\r\n        color1 = color0;\r\n    }\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    TransitionWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("    vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v) {\r\n    TransitionWrapMaterial material = {{name}};\r\n\r\n    vec4 color0 = {{mat0.name}}_render(v);\r\n    vec4 color1 = {{mat1.name}}_render(v);\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    TransitionWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("mat0.usesNormal",c,p,1),c,p,0,130,193,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        vec4 color0 =  ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat0.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("        vec4 color0 =  ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);if(t.s(t.d("mat1.usesNormal",c,p,1),c,p,0,342,405,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        vec4 color1 =  ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat1.usesNormal",c,p,1),c,p,1,0,0,"")){t.b("        vec4 color1 =  ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal) {\r\n    TransitionWrapMaterial material = {{name}};\r\n\r\n    {{#mat0.usesNormal}}\r\n        vec4 color0 =  {{mat0.name}}_render(v, normal);\r\n    {{/mat0.usesNormal}}\r\n    {{^mat0.usesNormal}}\r\n        vec4 color0 =  {{mat0.name}}_render(v);\r\n    {{/mat0.usesNormal}}\r\n\r\n    {{#mat1.usesNormal}}\r\n        vec4 color1 =  {{mat1.name}}_render(v, normal);\r\n    {{/mat1.usesNormal}}\r\n    {{^mat1.usesNormal}}\r\n        vec4 color1 =  {{mat1.name}}_render(v);\r\n    {{/mat1.usesNormal}}\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    TransitionWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(!t.s(t.d("mat0.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,278,344,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("    \r");t.b("\n" + i);if(t.s(t.d("mat0.usesNormal",c,p,1),c,p,0,421,667,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,568,642,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("mat1.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,854,920,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("    \r");t.b("\n" + i);if(t.s(t.d("mat1.usesNormal",c,p,1),c,p,0,997,1243,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("            vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,1144,1218,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    TransitionWrapMaterial material = {{name}};\r\n\r\n    {{^mat0.usesNormal}}\r\n        {{^mat0.usesUVMap}}\r\n            vec4 color0 = {{mat0.name}}_render(v);\r\n        {{/mat0.usesUVMap}}\r\n        {{#mat0.usesUVMap}}\r\n            vec4 color0 = {{mat0.name}}_render(v, uv);\r\n        {{/mat0.usesUVMap}}\r\n    {{/mat0.usesNormal}}\r\n    \r\n    {{#mat0.usesNormal}}\r\n        {{^mat0.usesUVMap}}\r\n            vec4 color0 = {{mat0.name}}_render(v, normal);\r\n        {{/mat0.usesUVMap}}\r\n        {{#mat0.usesUVMap}}\r\n            vec4 color0 = {{mat0.name}}_render(v, normal, uv);\r\n        {{/mat0.usesUVMap}}\r\n    {{/mat0.usesNormal}}\r\n\r\n    {{^mat1.usesNormal}}\r\n        {{^mat1.usesUVMap}}\r\n            vec4 color1 = {{mat1.name}}_render(v);\r\n        {{/mat1.usesUVMap}}\r\n        {{#mat1.usesUVMap}}\r\n            vec4 color1 = {{mat1.name}}_render(v, uv);\r\n        {{/mat1.usesUVMap}}\r\n    {{/mat1.usesNormal}}\r\n    \r\n    {{#mat1.usesNormal}}\r\n        {{^mat1.usesUVMap}}\r\n            vec4 color1 = {{mat1.name}}_render(v, normal);\r\n        {{/mat1.usesUVMap}}\r\n        {{#mat1.usesUVMap}}\r\n            vec4 color1 = {{mat1.name}}_render(v, normal, uv);\r\n        {{/mat1.usesUVMap}}\r\n    {{/mat1.usesNormal}}\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    TransitionWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("mat0.usesUVMap",c,p,1),c,p,0,120,178,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat0.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("        vec4 color0 = ");t.b(t.v(t.d("mat0.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);if(t.s(t.d("mat1.usesUVMap",c,p,1),c,p,0,322,380,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}if(!t.s(t.d("mat1.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("        vec4 color1 = ");t.b(t.v(t.d("mat1.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);t.b("    return (1. - material.ratio) * color0 + material.ratio * color1;\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, vec2 uv) {\r\n    TransitionWrapMaterial material = {{name}};\r\n\r\n    {{#mat0.usesUVMap}}\r\n        vec4 color0 = {{mat0.name}}_render(v, uv);\r\n    {{/mat0.usesUVMap}}\r\n    {{^mat0.usesUVMap}}\r\n        vec4 color0 = {{mat0.name}}_render(v);\r\n    {{/mat0.usesUVMap}}\r\n\r\n    {{#mat1.usesUVMap}}\r\n        vec4 color1 = {{mat1.name}}_render(v, uv);\r\n    {{/mat1.usesUVMap}}\r\n    {{^mat1.usesUVMap}}\r\n        vec4 color1 = {{mat1.name}}_render(v);\r\n    {{/mat1.usesUVMap}}\r\n\r\n    return (1. - material.ratio) * color0 + material.ratio * color1;\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for the complement of a shape\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    return - ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for the complement of a shape\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    return - {{shape.name}}_sdf(v);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec2 ");t.b(t.v(t.f("name",c,p,0)));t.b("_uvMap(RelVector v){\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec2 {{name}}_uvMap(RelVector v){\r\n    return {{shape.name}}_uvMap(v);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * Gradient for the union of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    RelVector grad1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    RelVector grad2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    return gradientMaxPoly(dist1, dist2, grad1, grad2, ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxCoeff);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * Gradient for the union of two shapes\r\n */\r\nRelVector {{name}}_gradient(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    RelVector grad1 = {{shape1.name}}_gradient(v);\r\n    RelVector grad2 = {{shape2.name}}_gradient(v);\r\n    return gradientMaxPoly(dist1, dist2, grad1, grad2, {{name}}.maxCoeff);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * Gradient for the intersection of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    if(dist1 > dist2){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    } else{\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * Gradient for the intersection of two shapes\r\n */\r\nRelVector {{name}}_gradient(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    if(dist1 > dist2){\r\n        return {{shape1.name}}_gradient(v);\r\n    } else{\r\n        return {{shape2.name}}_gradient(v);\r\n    }\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for the union of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    return smoothMaxPoly(dist1, dist2, ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxCoeff);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for the union of two shapes\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    return smoothMaxPoly(dist1, dist2, {{name}}.maxCoeff);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for the intersection of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    return max(dist1, dist2);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for the intersection of two shapes\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    return max(dist1, dist2);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * UV Map for the intersection of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("vec2 ");t.b(t.v(t.f("name",c,p,0)));t.b("_uvMap(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    if(dist1 < dist2){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_uvMap(v);\r");t.b("\n" + i);t.b("    } else{\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_uvMap(v);\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * UV Map for the intersection of two shapes\r\n */\r\nvec2 {{name}}_uvMap(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    if(dist1 < dist2){\r\n        return {{shape1.name}}_uvMap(v);\r\n    } else{\r\n        return {{shape2.name}}_uvMap(v);\r\n    }\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * Gradient for the union of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    RelVector grad1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    RelVector grad2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("    return gradientMinPoly(dist1, dist2, grad1, grad2, ");t.b(t.v(t.f("name",c,p,0)));t.b(".minCoeff);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * Gradient for the union of two shapes\r\n */\r\nRelVector {{name}}_gradient(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    RelVector grad1 = {{shape1.name}}_gradient(v);\r\n    RelVector grad2 = {{shape2.name}}_gradient(v);\r\n    return gradientMinPoly(dist1, dist2, grad1, grad2, {{name}}.minCoeff);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for the union of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    return smoothMinPoly(dist1, dist2, ");t.b(t.v(t.f("name",c,p,0)));t.b(".minCoeff);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for the union of two shapes\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    return smoothMinPoly(dist1, dist2, {{name}}.minCoeff);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for the union of two shapes\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    float dist1 = ");t.b(t.v(t.d("shape1.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    float dist2 = ");t.b(t.v(t.d("shape2.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    return min(dist1, dist2);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for the union of two shapes\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    float dist1 = {{shape1.name}}_sdf(v);\r\n    float dist2 = {{shape2.name}}_sdf(v);\r\n    return min(dist1, dist2);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * Gradient for a wrapping\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * Gradient for a wrapping\r\n */\r\nRelVector {{name}}_gradient(RelVector v){\r\n    return {{shape.name}}_gradient(v);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * SDF for a wrapping\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    float wrap = ");t.b(t.v(t.d("wrap.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    if(wrap > camera.threshold){\r");t.b("\n" + i);t.b("        return wrap;\r");t.b("\n" + i);t.b("    } else {\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * SDF for a wrapping\r\n */\r\nfloat {{name}}_sdf(RelVector v){\r\n    float wrap = {{wrap.name}}_sdf(v);\r\n    if(wrap > camera.threshold){\r\n        return wrap;\r\n    } else {\r\n        return {{shape.name}}_sdf(v);\r\n    }\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * Default creeping function (binary search)\r");t.b("\n" + i);t.b(" * @param start starting point of the creeping\r");t.b("\n" + i);t.b(" * @param outside vector out of the boundary (obtained from the previous flow, or the previous creeping)\r");t.b("\n" + i);t.b(" * @param offset how long we flow after passing the boundary\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("glslCreepName",c,p,0)));t.b("(ExtVector v, ExtVector outside,  float offset){\r");t.b("\n" + i);t.b("    ExtVector try = outside;\r");t.b("\n" + i);t.b("    float sIn = 0.;\r");t.b("\n" + i);t.b("    float sOut = try.data.lastFlowDist;\r");t.b("\n" + i);t.b("    float s;\r");t.b("\n" + i);t.b("    for(int i=0; i < 100; i++){\r");t.b("\n" + i);t.b("        if(sOut - sIn < offset){\r");t.b("\n" + i);t.b("            break;\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);t.b("        s = 0.5 * sIn + 0.5 * sOut;\r");t.b("\n" + i);t.b("        try = flow(v,s);\r");t.b("\n" + i);t.b("        if(");t.b(t.v(t.f("glslTestName",c,p,0)));t.b("(try.vector.local.pos)){\r");t.b("\n" + i);t.b("            sOut = s;\r");t.b("\n" + i);t.b("            outside = try;\r");t.b("\n" + i);t.b("        } else {\r");t.b("\n" + i);t.b("            sIn = s;\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return sOut;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * Default creeping function (binary search)\r\n * @param start starting point of the creeping\r\n * @param outside vector out of the boundary (obtained from the previous flow, or the previous creeping)\r\n * @param offset how long we flow after passing the boundary\r\n */\r\nfloat {{glslCreepName}}(ExtVector v, ExtVector outside,  float offset){\r\n    ExtVector try = outside;\r\n    float sIn = 0.;\r\n    float sOut = try.data.lastFlowDist;\r\n    float s;\r\n    for(int i=0; i < 100; i++){\r\n        if(sOut - sIn < offset){\r\n            break;\r\n        }\r\n        s = 0.5 * sIn + 0.5 * sOut;\r\n        try = flow(v,s);\r\n        if({{glslTestName}}(try.vector.local.pos)){\r\n            sOut = s;\r\n            outside = try;\r\n        } else {\r\n            sIn = s;\r\n        }\r\n    }\r\n    return sOut;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b("* Teleportation.\r");t.b("\n" + i);t.b("* Check if the local vector is still in the fundamental domain define by the teleportation tests.\r");t.b("\n" + i);t.b("* If not, teleport the local vector, update the cellBoost and its inverse accordingly and set teleported to true\r");t.b("\n" + i);t.b("* Otherwise, do nothing and set teleported to false\r");t.b("\n" + i);t.b("* @param[in] v the relative vector to teleport.\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("ExtVector teleport(ExtVector v){\r");t.b("\n" + i);t.b("    v.data.isTeleported = false;\r");t.b("\n" + i);if(t.s(t.f("teleportations",c,p,1),c,p,0,433,636,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        if(");t.b(t.v(t.f("glslTestName",c,p,0)));t.b("(v.vector.local.pos)){\r");t.b("\n" + i);t.b("            v.vector = rewrite(v.vector, ");t.b(t.v(t.d("elt.name",c,p,0)));t.b(", ");t.b(t.v(t.d("inv.name",c,p,0)));t.b(");\r");t.b("\n" + i);t.b("            v.data.isTeleported = true;\r");t.b("\n" + i);t.b("            return v;\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("    return v;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b("* Does one of the two following transformation:\r");t.b("\n" + i);t.b("* flow the vector by the given time, if the vector escape the fundamental domain,\r");t.b("\n" + i);t.b("* then try to find a smaller time so that the vector is moved closer to the boundary of the fudamental domain\r");t.b("\n" + i);t.b("* (and even a bit further)\r");t.b("\n" + i);t.b("*\r");t.b("\n" + i);t.b("* @param[inout] v the relative vector to flow / teleport / creep.\r");t.b("\n" + i);t.b("* @param[in] t the (maximal) time to flow\r");t.b("\n" + i);t.b("* @param[in] offset the amount we march passed the boundary\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("float creepingDist(ExtVector v, float t, float offset){\r");t.b("\n" + i);t.b("    float res = t;\r");t.b("\n" + i);t.b("    ExtVector try = flow(v, t);\r");t.b("\n" + i);if(t.s(t.f("teleportations",c,p,1),c,p,0,1266,1685,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("\r");t.b("\n" + i);if(t.s(t.f("usesCreepingCustom",c,p,1),c,p,0,1301,1446,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("glslTestName",c,p,0)));t.b("(try.vector.local.pos)){\r");t.b("\n" + i);t.b("                res = min(res, ");t.b(t.v(t.f("glslCreepName",c,p,0)));t.b("(v, offset));\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.f("usesCreepingBinary",c,p,1),c,p,0,1504,1654,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("glslTestName",c,p,0)));t.b("(try.vector.local.pos)){\r");t.b("\n" + i);t.b("                res = min(res, ");t.b(t.v(t.f("glslCreepName",c,p,0)));t.b("(v, try, offset));\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);});c.pop();}t.b("    return res;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n* Teleportation.\r\n* Check if the local vector is still in the fundamental domain define by the teleportation tests.\r\n* If not, teleport the local vector, update the cellBoost and its inverse accordingly and set teleported to true\r\n* Otherwise, do nothing and set teleported to false\r\n* @param[in] v the relative vector to teleport.\r\n*/\r\nExtVector teleport(ExtVector v){\r\n    v.data.isTeleported = false;\r\n    {{#teleportations}}\r\n        if({{glslTestName}}(v.vector.local.pos)){\r\n            v.vector = rewrite(v.vector, {{elt.name}}, {{inv.name}});\r\n            v.data.isTeleported = true;\r\n            return v;\r\n        }\r\n    {{/teleportations}}\r\n    return v;\r\n}\r\n\r\n\r\n/**\r\n* Does one of the two following transformation:\r\n* flow the vector by the given time, if the vector escape the fundamental domain,\r\n* then try to find a smaller time so that the vector is moved closer to the boundary of the fudamental domain\r\n* (and even a bit further)\r\n*\r\n* @param[inout] v the relative vector to flow / teleport / creep.\r\n* @param[in] t the (maximal) time to flow\r\n* @param[in] offset the amount we march passed the boundary\r\n*/\r\nfloat creepingDist(ExtVector v, float t, float offset){\r\n    float res = t;\r\n    ExtVector try = flow(v, t);\r\n    {{#teleportations}}\r\n\r\n        {{#usesCreepingCustom}}\r\n            if({{glslTestName}}(try.vector.local.pos)){\r\n                res = min(res, {{glslCreepName}}(v, offset));\r\n            }\r\n        {{/usesCreepingCustom}}\r\n\r\n        {{#usesCreepingBinary}}\r\n            if({{glslTestName}}(try.vector.local.pos)){\r\n                res = min(res, {{glslCreepName}}(v, try, offset));\r\n            }\r\n        {{/usesCreepingBinary}}\r\n\r\n    {{/teleportations}}\r\n    return res;\r\n}\r\n\r\n\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("bool ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(RelVector v, int i, out RelVector dir, out float intensity) {\r");t.b("\n" + i);t.b("    return directions(");t.b(t.v(t.f("name",c,p,0)));t.b(", v, i, dir, intensity);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "bool {{name}}_directions(RelVector v, int i, out RelVector dir, out float intensity) {\r\n    return directions({{name}}, v, i, dir, intensity);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec4 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    return render(");t.b(t.v(t.f("name",c,p,0)));t.b(", v, uv);\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec4 {{name}}_render(ExtVector v, vec2 uv) {\r\n    return render({{name}}, v, uv);\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/***********************************************************************************************************************\r");t.b("\n" + i);t.b(" ***********************************************************************************************************************\r");t.b("\n" + i);t.b(" * \r");t.b("\n" + i);t.b(" * Defines the scene SDF and scene Material computations used during the ray-marching and lightening.\r");t.b("\n" + i);t.b(" *\r");t.b("\n" + i);t.b(" ***********************************************************************************************************************\r");t.b("\n" + i);t.b(" **********************************************************************************************************************/\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b(" * Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r");t.b("\n" + i);t.b(" * @param[in] v the direction to follows\r");t.b("\n" + i);t.b(" * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b(" * @param[out] objId the ID of the solid we hit.\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float _localSceneSDF(RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    hit = HIT_NOTHING;\r");t.b("\n" + i);t.b("    float res = camera.maxDist;\r");t.b("\n" + i);t.b("    float dist;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,1043,1434,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("isLocal",c,p,1),c,p,0,1065,1416,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("name",c,p,0)));t.b(".isRendered && ");t.b(t.v(t.f("name",c,p,0)));t.b("_isRenderedHack){\r");t.b("\n" + i);t.b("                dist = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("                if(dist < camera.threshold) {\r");t.b("\n" + i);t.b("                    hit = HIT_SOLID;\r");t.b("\n" + i);t.b("                    objId = ");t.b(t.v(t.f("id",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return res;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b("* Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r");t.b("\n" + i);t.b("* When nearest neighbor is on, the representation of v can be updated\r");t.b("\n" + i);t.b("* so that the local vector is in a neighbor of the fundamental domain.\r");t.b("\n" + i);t.b("* This is used to compute correctly the normal / uv map of a local object.\r");t.b("\n" + i);t.b("* @param[in] v the direction to follows\r");t.b("\n" + i);t.b("* @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b("* @param[out] objId the ID of the solid we hit.\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("float localSceneSDF(inout RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    float res, dist;\r");t.b("\n" + i);t.b("    dist = _localSceneSDF(v, hit, objId);\r");t.b("\n" + i);t.b("    if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("        return dist;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    res = dist;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);if(t.s(t.d("set.usesNearestNeighbors",c,p,1),c,p,0,2222,2653,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        RelVector aux = v;\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);if(t.s(t.d("set.neighbors",c,p,1),c,p,0,2288,2598,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                aux = rewrite(v, ");t.b(t.v(t.d("elt.name",c,p,0)));t.b(", ");t.b(t.v(t.d("inv.name",c,p,0)));t.b(");\r");t.b("\n" + i);t.b("                dist = _localSceneSDF(aux, hit, objId);\r");t.b("\n" + i);t.b("                if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("                    v = aux;\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("                \r");t.b("\n" + i);});c.pop();}t.b("        \r");t.b("\n" + i);t.b("        return res;\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("set.usesNearestNeighbors",c,p,1),c,p,1,0,0,"")){t.b("        return res;\r");t.b("\n" + i);};t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b(" * Distance along the geodesic directed by \\`v\\` to the closest object in the global scene\r");t.b("\n" + i);t.b(" * @param[in] v the direction to follows\r");t.b("\n" + i);t.b(" * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b(" * @param[out] objID the ID of the solid we hit.\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float globalSceneSDF(RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    hit = HIT_NOTHING;\r");t.b("\n" + i);t.b("    float res = camera.maxDist;\r");t.b("\n" + i);t.b("    float dist;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,3230,3623,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("isGlobal",c,p,1),c,p,0,3253,3604,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("name",c,p,0)));t.b(".isRendered && ");t.b(t.v(t.f("name",c,p,0)));t.b("_isRenderedHack){\r");t.b("\n" + i);t.b("                dist = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("                if(dist < camera.threshold) {\r");t.b("\n" + i);t.b("                    hit = HIT_SOLID;\r");t.b("\n" + i);t.b("                    objId = ");t.b(t.v(t.f("id",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return res;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/***********************************************************************************************************************\r\n ***********************************************************************************************************************\r\n * \r\n * Defines the scene SDF and scene Material computations used during the ray-marching and lightening.\r\n *\r\n ***********************************************************************************************************************\r\n **********************************************************************************************************************/\r\n\r\n/**\r\n * Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r\n * @param[in] v the direction to follows\r\n * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n * @param[out] objId the ID of the solid we hit.\r\n */\r\nfloat _localSceneSDF(RelVector v, out int hit, out int objId){\r\n    hit = HIT_NOTHING;\r\n    float res = camera.maxDist;\r\n    float dist;\r\n\r\n    {{#scene.solids}}\r\n        {{#isLocal}}\r\n            if({{name}}.isRendered && {{name}}_isRenderedHack){\r\n                dist = {{shape.name}}_sdf(v);\r\n                if(dist < camera.threshold) {\r\n                    hit = HIT_SOLID;\r\n                    objId = {{id}};\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n            }\r\n        {{/isLocal}}\r\n    {{/scene.solids}}\r\n    \r\n    return res;\r\n}\r\n\r\n/**\r\n* Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r\n* When nearest neighbor is on, the representation of v can be updated\r\n* so that the local vector is in a neighbor of the fundamental domain.\r\n* This is used to compute correctly the normal / uv map of a local object.\r\n* @param[in] v the direction to follows\r\n* @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n* @param[out] objId the ID of the solid we hit.\r\n*/\r\nfloat localSceneSDF(inout RelVector v, out int hit, out int objId){\r\n    float res, dist;\r\n    dist = _localSceneSDF(v, hit, objId);\r\n    if(hit == HIT_SOLID) {\r\n        return dist;\r\n    }\r\n    res = dist;\r\n    \r\n    {{#set.usesNearestNeighbors}}\r\n        RelVector aux = v;\r\n        \r\n        {{#set.neighbors}}\r\n                aux = rewrite(v, {{elt.name}}, {{inv.name}});\r\n                dist = _localSceneSDF(aux, hit, objId);\r\n                if(hit == HIT_SOLID) {\r\n                    v = aux;\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n                \r\n        {{/set.neighbors}}\r\n        \r\n        return res;\r\n    {{/set.usesNearestNeighbors}}\r\n\r\n    {{^set.usesNearestNeighbors}}\r\n        return res;\r\n    {{/set.usesNearestNeighbors}}\r\n}\r\n\r\n\r\n/**\r\n * Distance along the geodesic directed by \\`v\\` to the closest object in the global scene\r\n * @param[in] v the direction to follows\r\n * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n * @param[out] objID the ID of the solid we hit.\r\n */\r\nfloat globalSceneSDF(RelVector v, out int hit, out int objId){\r\n    hit = HIT_NOTHING;\r\n    float res = camera.maxDist;\r\n    float dist;\r\n    \r\n    {{#scene.solids}}\r\n        {{#isGlobal}}\r\n            if({{name}}.isRendered && {{name}}_isRenderedHack){\r\n                dist = {{shape.name}}_sdf(v);\r\n                if(dist < camera.threshold) {\r\n                    hit = HIT_SOLID;\r\n                    objId = {{id}};\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n            }\r\n        {{/isGlobal}}\r\n    {{/scene.solids}}\r\n    \r\n    return res;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("VectorData initVectorData(){\r");t.b("\n" + i);t.b("    return VectorData(0., 0., 0., false, 0, 0, false, vec4(0), vec4(1));\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("void updateVectorDataFromSolid(inout ExtVector v, int objId){\r");t.b("\n" + i);t.b("    RelVector normal;\r");t.b("\n" + i);t.b("    vec2 uv;\r");t.b("\n" + i);t.b("    vec4 color;\r");t.b("\n" + i);t.b("    vec4 reflectivity;\r");t.b("\n" + i);t.b("    float opacity;\r");t.b("\n" + i);t.b("    float t;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);t.b("    switch(objId){\r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,333,6088,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    \r");t.b("\n" + i);t.b("        case ");t.b(t.v(t.f("id",c,p,0)));t.b(":\r");t.b("\n" + i);if(t.s(t.d("material.isTransparent",c,p,1),c,p,0,398,2264,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("\r");t.b("\n" + i);if(!t.s(t.d("material.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                    color =  ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,620,758,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                    uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                    color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);if(t.s(t.d("material.usesNormal",c,p,1),c,p,0,859,1361,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                    normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("                    color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,1113,1324,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                    normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("                    uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                    color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);t.b("            if(v.data.iBounce == maxBounces){\r");t.b("\n" + i);t.b("                opacity = 1.;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("            else {\r");t.b("\n" + i);t.b("                opacity = color.a;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("scene.fog",c,p,1),c,p,0,1581,1662,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                //color = applyFog(color, v.data.lastBounceDist);\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("            if(opacity == 1.) {\r");t.b("\n" + i);t.b("                v.data.stop = true;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("            else{\r");t.b("\n" + i);t.b("                v.data.stop = false;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("            v.data.pixel = v.data.pixel + v.data.leftToComputeColor * opacity * color;\r");t.b("\n" + i);t.b("            v.data.leftToComputeColor = (1. - opacity) * v.data.leftToComputeColor;\r");t.b("\n" + i);t.b("            ");t.b(t.v(t.f("name",c,p,0)));t.b("_isRenderedHack = false;\r");t.b("\n" + i);t.b("            v.data.lastBounceDist = 0.;\r");t.b("\n" + i);t.b("            v.data.iBounce = v.data.iBounce + 1;\r");t.b("\n" + i);t.b("            //t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r");t.b("\n" + i);t.b("            //v = flow(v, t);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("material.isTransparent",c,p,1),c,p,1,0,0,"")){t.b("\r");t.b("\n" + i);if(t.s(t.d("material.isReflecting",c,p,1),c,p,0,2372,4538,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("\r");t.b("\n" + i);t.b("                if(v.data.iBounce == maxBounces){\r");t.b("\n" + i);t.b("                    reflectivity = vec4(0);\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                else {\r");t.b("\n" + i);t.b("                    reflectivity = vec4(");t.b(t.v(t.d("material.name",c,p,0)));t.b(".reflectivity,1);\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("                normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("                // in general the gradient is not necessarily a unit vector\r");t.b("\n" + i);t.b("                normal = geomNormalize(normal);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(!t.s(t.d("material.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                        color =  ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,3039,3189,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                        uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);if(t.s(t.d("material.usesNormal",c,p,1),c,p,0,3298,3702,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,3503,3661,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                        uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.d("scene.fog",c,p,1),c,p,0,3760,3847,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                    color = applyFog(color, v.data.lastBounceDist);\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("                if(length(reflectivity) == 0.) {\r");t.b("\n" + i);t.b("                    v.data.stop = true;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                else{\r");t.b("\n" + i);t.b("                    v.data.stop = false;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                v.data.pixel = v.data.pixel + v.data.leftToComputeColor * (vec4(1) - reflectivity) * color;\r");t.b("\n" + i);t.b("                v.data.leftToComputeColor = v.data.leftToComputeColor *  reflectivity;\r");t.b("\n" + i);t.b("                v.vector = geomReflect(v.vector,normal);\r");t.b("\n" + i);t.b("                v.data.lastBounceDist = 0.;\r");t.b("\n" + i);t.b("                v.data.iBounce = v.data.iBounce + 1;\r");t.b("\n" + i);t.b("                t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r");t.b("\n" + i);t.b("                v = flow(v, t);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("material.isReflecting",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("material.usesNormal",c,p,1),c,p,1,0,0,"")){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                        color =  ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,4846,4996,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                        uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);});c.pop();}};t.b("\r");t.b("\n" + i);if(t.s(t.d("material.usesNormal",c,p,1),c,p,0,5105,5647,"{{ }}")){t.rs(c,p,function(c,p,t){if(!t.s(t.d("material.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                        normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);};if(t.s(t.d("material.usesUVMap",c,p,1),c,p,0,5379,5606,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                        normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("                        uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                        color = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.d("scene.fog",c,p,1),c,p,0,5705,5792,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                    color = applyFog(color, v.data.lastBounceDist);\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);t.b("                v.data.pixel = v.data.pixel + v.data.leftToComputeColor * color;\r");t.b("\n" + i);t.b("                v.data.leftToComputeColor = vec4(0);\r");t.b("\n" + i);t.b("                v.data.stop = true;\r");t.b("\n" + i);};t.b("\r");t.b("\n" + i);};t.b("        break;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);});c.pop();}t.b("    }\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("void updateVectorData(inout ExtVector v, int hit, int objId){\r");t.b("\n" + i);t.b("    if (hit == HIT_DEBUG) {\r");t.b("\n" + i);t.b("        v.data.pixel = debugColor;\r");t.b("\n" + i);t.b("        v.data.leftToComputeColor = vec4(0);\r");t.b("\n" + i);t.b("        v.data.stop = true;\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    if (hit == HIT_NOTHING) {\r");t.b("\n" + i);t.b("        vec4 color = ");t.b(t.v(t.d("scene.background.name",c,p,0)));t.b("_render(v);\r");t.b("\n" + i);t.b("        v.data.pixel = v.data.pixel + v.data.leftToComputeColor * color;\r");t.b("\n" + i);t.b("        v.data.leftToComputeColor = vec4(0);\r");t.b("\n" + i);t.b("        v.data.stop = true;\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("        updateVectorDataFromSolid(v, objId);\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "VectorData initVectorData(){\r\n    return VectorData(0., 0., 0., false, 0, 0, false, vec4(0), vec4(1));\r\n}\r\n\r\n\r\nvoid updateVectorDataFromSolid(inout ExtVector v, int objId){\r\n    RelVector normal;\r\n    vec2 uv;\r\n    vec4 color;\r\n    vec4 reflectivity;\r\n    float opacity;\r\n    float t;\r\n    \r\n    switch(objId){\r\n    {{#scene.solids}}\r\n    \r\n        case {{id}}:\r\n        {{#material.isTransparent}}\r\n\r\n            {{^material.usesNormal}}\r\n                {{^material.usesUVMap}}\r\n                    color =  {{material.name}}_render(v);\r\n                {{/material.usesUVMap}}\r\n                {{#material.usesUVMap}}\r\n                    uv = {{shape.name}}_uvMap(v.vector);\r\n                    color = {{material.name}}_render(v, uv);\r\n                {{/material.usesUVMap}}\r\n            {{/material.usesNormal}}\r\n\r\n            {{#material.usesNormal}}\r\n                {{^material.usesUVMap}}\r\n                    normal = {{shape.name}}_gradient(v.vector);\r\n                    color = {{material.name}}_render(v, normal);\r\n                {{/material.usesUVMap}}\r\n                {{#material.usesUVMap}}\r\n                    normal = {{shape.name}}_gradient(v.vector);\r\n                    uv = {{shape.name}}_uvMap(v.vector);\r\n                    color = {{material.name}}_render(v, normal, uv);\r\n                {{/material.usesUVMap}}\r\n            {{/material.usesNormal}}\r\n\r\n            if(v.data.iBounce == maxBounces){\r\n                opacity = 1.;\r\n            }\r\n            else {\r\n                opacity = color.a;\r\n            }\r\n\r\n            {{#scene.fog}}\r\n                //color = applyFog(color, v.data.lastBounceDist);\r\n            {{/scene.fog}}\r\n\r\n            if(opacity == 1.) {\r\n                v.data.stop = true;\r\n            }\r\n            else{\r\n                v.data.stop = false;\r\n            }\r\n            v.data.pixel = v.data.pixel + v.data.leftToComputeColor * opacity * color;\r\n            v.data.leftToComputeColor = (1. - opacity) * v.data.leftToComputeColor;\r\n            {{name}}_isRenderedHack = false;\r\n            v.data.lastBounceDist = 0.;\r\n            v.data.iBounce = v.data.iBounce + 1;\r\n            //t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r\n            //v = flow(v, t);\r\n\r\n        {{/material.isTransparent}}\r\n\r\n        {{^material.isTransparent}}\r\n\r\n            {{#material.isReflecting}}\r\n\r\n                if(v.data.iBounce == maxBounces){\r\n                    reflectivity = vec4(0);\r\n                }\r\n                else {\r\n                    reflectivity = vec4({{material.name}}.reflectivity,1);\r\n                }\r\n\r\n                normal = {{shape.name}}_gradient(v.vector);\r\n                // in general the gradient is not necessarily a unit vector\r\n                normal = geomNormalize(normal);\r\n\r\n                {{^material.usesNormal}}\r\n                    {{^material.usesUVMap}}\r\n                        color =  {{material.name}}_render(v);\r\n                    {{/material.usesUVMap}}\r\n                    {{#material.usesUVMap}}\r\n                        uv = {{shape.name}}_uvMap(v.vector);\r\n                        color = {{material.name}}_render(v, uv);\r\n                    {{/material.usesUVMap}}\r\n                {{/material.usesNormal}}\r\n\r\n                {{#material.usesNormal}}\r\n                    {{^material.usesUVMap}}\r\n                        color = {{material.name}}_render(v, normal);\r\n                    {{/material.usesUVMap}}\r\n                    {{#material.usesUVMap}}\r\n                        uv = {{shape.name}}_uvMap(v.vector);\r\n                        color = {{material.name}}_render(v, normal, uv);\r\n                    {{/material.usesUVMap}}\r\n                {{/material.usesNormal}}\r\n\r\n                {{#scene.fog}}\r\n                    color = applyFog(color, v.data.lastBounceDist);\r\n                {{/scene.fog}}\r\n\r\n                if(length(reflectivity) == 0.) {\r\n                    v.data.stop = true;\r\n                }\r\n                else{\r\n                    v.data.stop = false;\r\n                }\r\n                v.data.pixel = v.data.pixel + v.data.leftToComputeColor * (vec4(1) - reflectivity) * color;\r\n                v.data.leftToComputeColor = v.data.leftToComputeColor *  reflectivity;\r\n                v.vector = geomReflect(v.vector,normal);\r\n                v.data.lastBounceDist = 0.;\r\n                v.data.iBounce = v.data.iBounce + 1;\r\n                t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r\n                v = flow(v, t);\r\n\r\n            {{/material.isReflecting}}\r\n\r\n            {{^material.isReflecting}}\r\n                {{^material.usesNormal}}\r\n                    {{^material.usesUVMap}}\r\n                        color =  {{material.name}}_render(v);\r\n                    {{/material.usesUVMap}}\r\n                    {{#material.usesUVMap}}\r\n                        uv = {{shape.name}}_uvMap(v.vector);\r\n                        color = {{material.name}}_render(v, uv);\r\n                    {{/material.usesUVMap}}\r\n                {{/material.usesNormal}}\r\n\r\n                {{#material.usesNormal}}\r\n                    {{^material.usesUVMap}}\r\n                        normal = {{shape.name}}_gradient(v.vector);\r\n                        color = {{material.name}}_render(v, normal);\r\n                    {{/material.usesUVMap}}\r\n                    {{#material.usesUVMap}}\r\n                        normal = {{shape.name}}_gradient(v.vector);\r\n                        uv = {{shape.name}}_uvMap(v.vector);\r\n                        color = {{material.name}}_render(v, normal, uv);\r\n                    {{/material.usesUVMap}}\r\n                {{/material.usesNormal}}\r\n\r\n                {{#scene.fog}}\r\n                    color = applyFog(color, v.data.lastBounceDist);\r\n                {{/scene.fog}}\r\n\r\n                v.data.pixel = v.data.pixel + v.data.leftToComputeColor * color;\r\n                v.data.leftToComputeColor = vec4(0);\r\n                v.data.stop = true;\r\n            {{/material.isReflecting}}\r\n\r\n        {{/material.isTransparent}}\r\n        break;\r\n    \r\n    {{/scene.solids}}\r\n    }\r\n}\r\n\r\nvoid updateVectorData(inout ExtVector v, int hit, int objId){\r\n    if (hit == HIT_DEBUG) {\r\n        v.data.pixel = debugColor;\r\n        v.data.leftToComputeColor = vec4(0);\r\n        v.data.stop = true;\r\n        return;\r\n    }\r\n    if (hit == HIT_NOTHING) {\r\n        vec4 color = {{scene.background.name}}_render(v);\r\n        v.data.pixel = v.data.pixel + v.data.leftToComputeColor * color;\r\n        v.data.leftToComputeColor = vec4(0);\r\n        v.data.stop = true;\r\n        return;\r\n    }\r\n    if(hit == HIT_SOLID) {\r\n        updateVectorDataFromSolid(v, objId);\r\n        return;\r\n    }\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b(" * We assume that we are inside a solid\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("void nextObjectProperties(RelVector normal, out float ior, out vec3 absorb,out vec3 emission,out float opticalDepth, out bool isInside){\r");t.b("\n" + i);t.b("    float dist;\r");t.b("\n" + i);t.b("    ior = ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".ior; // index of the \"air\"\r");t.b("\n" + i);t.b("    absorb = ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".absorb; // absorb of the \"air\"\r");t.b("\n" + i);t.b("    emission=vec3(0,0,0);//no emission from 'air'\r");t.b("\n" + i);t.b("    opticalDepth=");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".opticalDepth; // opticalDepth of the \"air\"\r");t.b("\n" + i);t.b("    isInside = false;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);t.b("    RelVector v = flow(normal, 2. * camera.threshold);\r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,591,1034,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        if(");t.b(t.v(t.f("name",c,p,0)));t.b(".isRendered){\r");t.b("\n" + i);t.b("            dist = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("            if(dist < camera.threshold) {\r");t.b("\n" + i);t.b("                ior = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".ior;\r");t.b("\n" + i);t.b("                absorb = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".absorb;\r");t.b("\n" + i);t.b("                emission = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".volumeEmission;\r");t.b("\n" + i);t.b("                opticalDepth = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".opticalDepth;\r");t.b("\n" + i);t.b("                isInside = true;\r");t.b("\n" + i);t.b("                return;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n * We assume that we are inside a solid\r\n */\r\nvoid nextObjectProperties(RelVector normal, out float ior, out vec3 absorb,out vec3 emission,out float opticalDepth, out bool isInside){\r\n    float dist;\r\n    ior = {{scene.ptBackground.name}}.ior; // index of the \"air\"\r\n    absorb = {{scene.ptBackground.name}}.absorb; // absorb of the \"air\"\r\n    emission=vec3(0,0,0);//no emission from 'air'\r\n    opticalDepth={{scene.ptBackground.name}}.opticalDepth; // opticalDepth of the \"air\"\r\n    isInside = false;\r\n    \r\n    RelVector v = flow(normal, 2. * camera.threshold);\r\n    {{#scene.solids}}\r\n        if({{name}}.isRendered){\r\n            dist = {{shape.name}}_sdf(v);\r\n            if(dist < camera.threshold) {\r\n                ior = {{ptMaterial.name}}.ior;\r\n                absorb = {{ptMaterial.name}}.absorb;\r\n                emission = {{ptMaterial.name}}.volumeEmission;\r\n                opticalDepth = {{ptMaterial.name}}.opticalDepth;\r\n                isInside = true;\r\n                return;\r\n            }\r\n        }\r\n    {{/scene.solids}}\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/***********************************************************************************************************************\r");t.b("\n" + i);t.b(" ***********************************************************************************************************************\r");t.b("\n" + i);t.b(" * \r");t.b("\n" + i);t.b(" * Defines the scene SDF and scene Material computations used during the ray-marching and lightening.\r");t.b("\n" + i);t.b(" *\r");t.b("\n" + i);t.b(" ***********************************************************************************************************************\r");t.b("\n" + i);t.b(" **********************************************************************************************************************/\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b(" * Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r");t.b("\n" + i);t.b(" * @param[in] v the direction to follows\r");t.b("\n" + i);t.b(" * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b(" * @param[out] objId the ID of the solid we hit.\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float _localSceneSDF(RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    hit = HIT_NOTHING;\r");t.b("\n" + i);t.b("    float res = camera.maxDist;\r");t.b("\n" + i);t.b("    float dist;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,1043,1412,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("isLocal",c,p,1),c,p,0,1065,1394,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("name",c,p,0)));t.b(".isRendered){\r");t.b("\n" + i);t.b("                dist = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("                if(abs(dist) < camera.threshold) {\r");t.b("\n" + i);t.b("                    hit = HIT_SOLID;\r");t.b("\n" + i);t.b("                    objId = ");t.b(t.v(t.f("id",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return res;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b("* Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r");t.b("\n" + i);t.b("* When nearest neighbor is on, the representatiion of v can be updated \r");t.b("\n" + i);t.b("* so that the local vector is in a neighbor of the fundamental domain.\r");t.b("\n" + i);t.b("* This is used to compute correctly the normal / uv map of a local object.\r");t.b("\n" + i);t.b("* @param[in] v the direction to follows\r");t.b("\n" + i);t.b("* @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b("* @param[out] objId the ID of the solid we hit.\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("float localSceneSDF(inout RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    float res, dist;\r");t.b("\n" + i);t.b("    dist = _localSceneSDF(v, hit, objId);\r");t.b("\n" + i);t.b("    if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("        return dist;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    res = dist;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);if(t.s(t.d("set.usesNearestNeighbors",c,p,1),c,p,0,2202,2633,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        RelVector aux = v;\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);if(t.s(t.d("set.neighbors",c,p,1),c,p,0,2268,2578,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                aux = rewrite(v, ");t.b(t.v(t.d("elt.name",c,p,0)));t.b(", ");t.b(t.v(t.d("inv.name",c,p,0)));t.b(");\r");t.b("\n" + i);t.b("                dist = _localSceneSDF(aux, hit, objId);\r");t.b("\n" + i);t.b("                if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("                    v = aux;\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("                \r");t.b("\n" + i);});c.pop();}t.b("        \r");t.b("\n" + i);t.b("        return res;\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(!t.s(t.d("set.usesNearestNeighbors",c,p,1),c,p,1,0,0,"")){t.b("        return res;\r");t.b("\n" + i);};t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("/**\r");t.b("\n" + i);t.b(" * Distance along the geodesic directed by \\`v\\` to the closest object in the global scene\r");t.b("\n" + i);t.b(" * @param[in] v the direction to follows\r");t.b("\n" + i);t.b(" * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r");t.b("\n" + i);t.b(" * @param[out] objID the ID of the solid we hit.\r");t.b("\n" + i);t.b(" */\r");t.b("\n" + i);t.b("float globalSceneSDF(RelVector v, out int hit, out int objId){\r");t.b("\n" + i);t.b("    hit = HIT_NOTHING;\r");t.b("\n" + i);t.b("    float res = camera.maxDist;\r");t.b("\n" + i);t.b("    float dist;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,3210,3581,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("isGlobal",c,p,1),c,p,0,3233,3562,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("            if(");t.b(t.v(t.f("name",c,p,0)));t.b(".isRendered){\r");t.b("\n" + i);t.b("                dist = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v);\r");t.b("\n" + i);t.b("                if(abs(dist) < camera.threshold) {\r");t.b("\n" + i);t.b("                    hit = HIT_SOLID;\r");t.b("\n" + i);t.b("                    objId = ");t.b(t.v(t.f("id",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("                    return dist;\r");t.b("\n" + i);t.b("                }\r");t.b("\n" + i);t.b("                res = min(res, dist);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);});c.pop();}});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return res;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/***********************************************************************************************************************\r\n ***********************************************************************************************************************\r\n * \r\n * Defines the scene SDF and scene Material computations used during the ray-marching and lightening.\r\n *\r\n ***********************************************************************************************************************\r\n **********************************************************************************************************************/\r\n\r\n/**\r\n * Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r\n * @param[in] v the direction to follows\r\n * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n * @param[out] objId the ID of the solid we hit.\r\n */\r\nfloat _localSceneSDF(RelVector v, out int hit, out int objId){\r\n    hit = HIT_NOTHING;\r\n    float res = camera.maxDist;\r\n    float dist;\r\n\r\n    {{#scene.solids}}\r\n        {{#isLocal}}\r\n            if({{name}}.isRendered){\r\n                dist = {{shape.name}}_sdf(v);\r\n                if(abs(dist) < camera.threshold) {\r\n                    hit = HIT_SOLID;\r\n                    objId = {{id}};\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n            }\r\n        {{/isLocal}}\r\n    {{/scene.solids}}\r\n    \r\n    return res;\r\n}\r\n\r\n/**\r\n* Distance along the geodesic directed by \\`v\\` to the closest object in the local scene\r\n* When nearest neighbor is on, the representatiion of v can be updated \r\n* so that the local vector is in a neighbor of the fundamental domain.\r\n* This is used to compute correctly the normal / uv map of a local object.\r\n* @param[in] v the direction to follows\r\n* @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n* @param[out] objId the ID of the solid we hit.\r\n*/\r\nfloat localSceneSDF(inout RelVector v, out int hit, out int objId){\r\n    float res, dist;\r\n    dist = _localSceneSDF(v, hit, objId);\r\n    if(hit == HIT_SOLID) {\r\n        return dist;\r\n    }\r\n    res = dist;\r\n    \r\n    {{#set.usesNearestNeighbors}}\r\n        RelVector aux = v;\r\n        \r\n        {{#set.neighbors}}\r\n                aux = rewrite(v, {{elt.name}}, {{inv.name}});\r\n                dist = _localSceneSDF(aux, hit, objId);\r\n                if(hit == HIT_SOLID) {\r\n                    v = aux;\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n                \r\n        {{/set.neighbors}}\r\n        \r\n        return res;\r\n    {{/set.usesNearestNeighbors}}\r\n\r\n    {{^set.usesNearestNeighbors}}\r\n        return res;\r\n    {{/set.usesNearestNeighbors}}\r\n}\r\n\r\n\r\n/**\r\n * Distance along the geodesic directed by \\`v\\` to the closest object in the global scene\r\n * @param[in] v the direction to follows\r\n * @param[out] hit say if we hit an object (1), nothing (0) or if there is a bug (-1)\r\n * @param[out] objID the ID of the solid we hit.\r\n */\r\nfloat globalSceneSDF(RelVector v, out int hit, out int objId){\r\n    hit = HIT_NOTHING;\r\n    float res = camera.maxDist;\r\n    float dist;\r\n    \r\n    {{#scene.solids}}\r\n        {{#isGlobal}}\r\n            if({{name}}.isRendered){\r\n                dist = {{shape.name}}_sdf(v);\r\n                if(abs(dist) < camera.threshold) {\r\n                    hit = HIT_SOLID;\r\n                    objId = {{id}};\r\n                    return dist;\r\n                }\r\n                res = min(res, dist);\r\n            }\r\n        {{/isGlobal}}\r\n    {{/scene.solids}}\r\n    \r\n    return res;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("VectorData initVectorData(){\r");t.b("\n" + i);t.b("    return VectorData(0., 0., 0., false, 0, 0, false, vec3(0), vec3(1), ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".absorb, ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".volumeEmission, ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".opticalDepth, false);\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("void roulette(inout ExtVector v){\r");t.b("\n" + i);t.b("    // as the light left gets smaller, the ray is more likely to get terminated early.\r");t.b("\n" + i);t.b("    // survivors have their value boosted to make up for fewer samples being in the average.\r");t.b("\n" + i);t.b("    float p = max(v.data.light.r, max(v.data.light.g, v.data.light.b));\r");t.b("\n" + i);t.b("    if (randomFloat() > p){\r");t.b("\n" + i);t.b("        v.data.stop = true;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    // add the energy we 'lose' by randomly terminating paths\r");t.b("\n" + i);t.b("    v.data.light = v.data.light / p;\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("void updateVectorDataFromSolid(inout ExtVector v, int objId){\r");t.b("\n" + i);t.b("    RelVector normal;\r");t.b("\n" + i);t.b("    RayType rayType;\r");t.b("\n" + i);t.b("    vec2 uv;\r");t.b("\n" + i);t.b("    vec3 color;\r");t.b("\n" + i);t.b("    vec3 reflectivity;\r");t.b("\n" + i);t.b("    float hackCoeff = 1.;\r");t.b("\n" + i);t.b("    float r; /** ratio of IOR */\r");t.b("\n" + i);t.b("    float nextIOR; /** IOR of the neighbor solid */\r");t.b("\n" + i);t.b("    vec3 nextAbsorb; /** absorb of the neighbor solid */\r");t.b("\n" + i);t.b("    vec3 nextEmission;/** volumetric emission of the neighbor solid */\r");t.b("\n" + i);t.b("    float nextOpticalDepth;/** optical depth of the neighbor solid */\r");t.b("\n" + i);t.b("    bool nextIsInside = true;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    RelVector diffuseDir;\r");t.b("\n" + i);t.b("    RelVector reflectDir;\r");t.b("\n" + i);t.b("    RelVector refractDir;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    // get a uniformly distributed vector on the sphere\r");t.b("\n" + i);t.b("    RelVector random = randomVector(v.vector);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    //get volumetric coloring:\r");t.b("\n" + i);t.b("    //portion of light is absorbed.\r");t.b("\n" + i);t.b("    vec3 volAbsorb = exp((-v.data.currentAbsorb) * v.data.lastBounceDist);\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);t.b("    //light is emitted along the journey (linear or expoenential pickup)\r");t.b("\n" + i);t.b("    vec3 volEmit = v.data.currentEmission * v.data.lastBounceDist;\r");t.b("\n" + i);t.b("    //vec3 volEmit = exp(v.data.currentEmission * v.data.lastBounceDist)-vec3(1);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    //use these quantities to update pixel and light:\r");t.b("\n" + i);t.b("    v.data.light = v.data.light * volAbsorb;\r");t.b("\n" + i);t.b("    v.data.pixel = v.data.pixel + v.data.light*volEmit;\r");t.b("\n" + i);t.b("    v.data.light = v.data.light + volEmit;//the absorbtion doesn't distort the light output\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("switch(objId){\r");t.b("\n" + i);if(t.s(t.d("scene.solids",c,p,1),c,p,0,2100,5396,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    \r");t.b("\n" + i);t.b("        case ");t.b(t.v(t.f("id",c,p,0)));t.b(":\r");t.b("\n" + i);t.b("            normal = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v.vector);\r");t.b("\n" + i);t.b("            normal = geomNormalize(normal);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("            \r");t.b("\n" + i);t.b("            // get info and reset normal based on which side we are on.\r");t.b("\n" + i);t.b("            // starting assumption: in the \"air\"\r");t.b("\n" + i);t.b("            r = ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".ior / ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".ior;\r");t.b("\n" + i);t.b("            nextAbsorb = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".absorb;\r");t.b("\n" + i);t.b("            nextEmission = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".volumeEmission;\r");t.b("\n" + i);t.b("            nextOpticalDepth = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".opticalDepth;\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            if(v.data.isInside){\r");t.b("\n" + i);t.b("                //things to change if we are inside a material instead:\r");t.b("\n" + i);t.b("                nextObjectProperties(normal, nextIOR, nextAbsorb,nextEmission, nextOpticalDepth,nextIsInside);\r");t.b("\n" + i);t.b("                r = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".ior / nextIOR;\r");t.b("\n" + i);t.b("                normal = negate(normal);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            rayType = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b("_setRayType(v, normal,r);\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);if(!t.s(t.d("ptMaterial.usesUVMap",c,p,1),c,p,1,0,0,"")){t.b("                color =  ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b("_render(v, normal, rayType);\r");t.b("\n" + i);};if(t.s(t.d("ptMaterial.usesUVMap",c,p,1),c,p,0,3250,3395,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("                uv = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_uvMap(v.vector);\r");t.b("\n" + i);t.b("                color = ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b("_render(v, normal, uv, rayType);\r");t.b("\n" + i);});c.pop();}t.b("        \r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("        // hack to make sure that lights are not too bright\r");t.b("\n" + i);t.b("            if(v.data.iBounce == 0){\r");t.b("\n" + i);t.b("                hackCoeff = 0.2;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            //apply surface effects\r");t.b("\n" + i);t.b("            v.data.pixel = v.data.pixel + hackCoeff * v.data.light * ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".emission;\r");t.b("\n" + i);t.b("            if(!rayType.refract){\r");t.b("\n" + i);t.b("                v.data.light = v.data.light * color / max(rayType.chance, 0.0001);\r");t.b("\n" + i);t.b("             }\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            // update the ray direction\r");t.b("\n" + i);t.b("            // diffuse uses a normal oriented cosine weighted hemisphere sample.\r");t.b("\n" + i);t.b("            diffuseDir = geomNormalize(add(normal, random));\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            if(rayType.diffuse){\r");t.b("\n" + i);t.b("                v.vector = diffuseDir;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            if(rayType.reflect){\r");t.b("\n" + i);t.b("                // perfectly smooth specular uses the reflection ray.\r");t.b("\n" + i);t.b("                reflectDir = geomReflect(v.vector, normal);\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("                // rough (glossy) specular lerps from the smooth specular to the rough diffuse by the material roughness squared\r");t.b("\n" + i);t.b("               // reflectDir = geomNormalize(geomMix(reflectDir, diffuseDir, ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".roughness * ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".roughness));\r");t.b("\n" + i);t.b("                v.vector = reflectDir;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        \r");t.b("\n" + i);t.b("            if(rayType.refract){\r");t.b("\n" + i);t.b("                    refractDir = geomRefract(v.vector,normal, r);\r");t.b("\n" + i);t.b("                    // rough (glossy) specular lerps from the smooth specular to the rough diffuse by the material roughness squared\r");t.b("\n" + i);t.b("                    refractDir = geomNormalize(geomMix(refractDir, diffuseDir, ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".roughness * ");t.b(t.v(t.d("ptMaterial.name",c,p,0)));t.b(".roughness));\r");t.b("\n" + i);t.b("                    v.data.isInside = nextIsInside;\r");t.b("\n" + i);t.b("                    v.data.currentAbsorb = nextAbsorb;\r");t.b("\n" + i);t.b("                    v.data.currentEmission = nextEmission;\r");t.b("\n" + i);t.b("                    v.data.currentOpticalDepth = nextOpticalDepth;\r");t.b("\n" + i);t.b("                    v.vector = refractDir;\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("            break;\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);});c.pop();}t.b("    }\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    v.data.lastBounceDist = 0.;\r");t.b("\n" + i);t.b("    v.data.iBounce = v.data.iBounce + 1;\r");t.b("\n" + i);t.b("    // be carefull, v is not normal to the surface\r");t.b("\n" + i);t.b("    // if the time we flow is too small, we are still below the camera threshold\r");t.b("\n" + i);t.b("    float t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r");t.b("\n" + i);t.b("    v = flow(v, t);\r");t.b("\n" + i);t.b("}\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("void updateVectorData(inout ExtVector v, int hit, int objId){\r");t.b("\n" + i);t.b("    if (hit == HIT_DEBUG) {\r");t.b("\n" + i);t.b("        v.data.pixel = debugColor.rgb;\r");t.b("\n" + i);t.b("        v.data.stop = true;\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    if (hit == HIT_NOTHING) {\r");t.b("\n" + i);t.b("        vec3 bgColor = ");t.b(t.v(t.d("scene.ptBackground.name",c,p,0)));t.b(".diffuse;\r");t.b("\n" + i);t.b("        v.data.pixel = v.data.pixel + v.data.light * bgColor;\r");t.b("\n" + i);t.b("        v.data.stop = true;\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    if(hit == HIT_SOLID) {\r");t.b("\n" + i);t.b("        updateVectorDataFromSolid(v, objId);\r");t.b("\n" + i);t.b("        roulette(v);\r");t.b("\n" + i);t.b("        return;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "VectorData initVectorData(){\r\n    return VectorData(0., 0., 0., false, 0, 0, false, vec3(0), vec3(1), {{scene.ptBackground.name}}.absorb, {{scene.ptBackground.name}}.volumeEmission, {{scene.ptBackground.name}}.opticalDepth, false);\r\n}\r\n\r\n\r\n\r\nvoid roulette(inout ExtVector v){\r\n    // as the light left gets smaller, the ray is more likely to get terminated early.\r\n    // survivors have their value boosted to make up for fewer samples being in the average.\r\n    float p = max(v.data.light.r, max(v.data.light.g, v.data.light.b));\r\n    if (randomFloat() > p){\r\n        v.data.stop = true;\r\n    }\r\n    // add the energy we 'lose' by randomly terminating paths\r\n    v.data.light = v.data.light / p;\r\n}\r\n\r\n\r\n\r\nvoid updateVectorDataFromSolid(inout ExtVector v, int objId){\r\n    RelVector normal;\r\n    RayType rayType;\r\n    vec2 uv;\r\n    vec3 color;\r\n    vec3 reflectivity;\r\n    float hackCoeff = 1.;\r\n    float r; /** ratio of IOR */\r\n    float nextIOR; /** IOR of the neighbor solid */\r\n    vec3 nextAbsorb; /** absorb of the neighbor solid */\r\n    vec3 nextEmission;/** volumetric emission of the neighbor solid */\r\n    float nextOpticalDepth;/** optical depth of the neighbor solid */\r\n    bool nextIsInside = true;\r\n\r\n    RelVector diffuseDir;\r\n    RelVector reflectDir;\r\n    RelVector refractDir;\r\n\r\n    // get a uniformly distributed vector on the sphere\r\n    RelVector random = randomVector(v.vector);\r\n\r\n\r\n\r\n\r\n\r\n    //get volumetric coloring:\r\n    //portion of light is absorbed.\r\n    vec3 volAbsorb = exp((-v.data.currentAbsorb) * v.data.lastBounceDist);\r\n    \r\n    //light is emitted along the journey (linear or expoenential pickup)\r\n    vec3 volEmit = v.data.currentEmission * v.data.lastBounceDist;\r\n    //vec3 volEmit = exp(v.data.currentEmission * v.data.lastBounceDist)-vec3(1);\r\n\r\n    //use these quantities to update pixel and light:\r\n    v.data.light = v.data.light * volAbsorb;\r\n    v.data.pixel = v.data.pixel + v.data.light*volEmit;\r\n    v.data.light = v.data.light + volEmit;//the absorbtion doesn't distort the light output\r\n    \r\n\r\n\r\n\r\n\r\n\r\n\r\nswitch(objId){\r\n    {{#scene.solids}}\r\n    \r\n        case {{id}}:\r\n            normal = {{shape.name}}_gradient(v.vector);\r\n            normal = geomNormalize(normal);\r\n\r\n            \r\n            // get info and reset normal based on which side we are on.\r\n            // starting assumption: in the \"air\"\r\n            r = {{scene.ptBackground.name}}.ior / {{ptMaterial.name}}.ior;\r\n            nextAbsorb = {{ptMaterial.name}}.absorb;\r\n            nextEmission = {{ptMaterial.name}}.volumeEmission;\r\n            nextOpticalDepth = {{ptMaterial.name}}.opticalDepth;\r\n        \r\n            if(v.data.isInside){\r\n                //things to change if we are inside a material instead:\r\n                nextObjectProperties(normal, nextIOR, nextAbsorb,nextEmission, nextOpticalDepth,nextIsInside);\r\n                r = {{ptMaterial.name}}.ior / nextIOR;\r\n                normal = negate(normal);\r\n            }\r\n        \r\n            rayType = {{ptMaterial.name}}_setRayType(v, normal,r);\r\n        \r\n            {{^ptMaterial.usesUVMap}}\r\n                color =  {{ptMaterial.name}}_render(v, normal, rayType);\r\n            {{/ptMaterial.usesUVMap}}\r\n            {{#ptMaterial.usesUVMap}}\r\n                uv = {{shape.name}}_uvMap(v.vector);\r\n                color = {{ptMaterial.name}}_render(v, normal, uv, rayType);\r\n            {{/ptMaterial.usesUVMap}}\r\n        \r\n        \r\n        // hack to make sure that lights are not too bright\r\n            if(v.data.iBounce == 0){\r\n                hackCoeff = 0.2;\r\n            }\r\n        \r\n            //apply surface effects\r\n            v.data.pixel = v.data.pixel + hackCoeff * v.data.light * {{ptMaterial.name}}.emission;\r\n            if(!rayType.refract){\r\n                v.data.light = v.data.light * color / max(rayType.chance, 0.0001);\r\n             }\r\n        \r\n            // update the ray direction\r\n            // diffuse uses a normal oriented cosine weighted hemisphere sample.\r\n            diffuseDir = geomNormalize(add(normal, random));\r\n        \r\n            if(rayType.diffuse){\r\n                v.vector = diffuseDir;\r\n            }\r\n        \r\n            if(rayType.reflect){\r\n                // perfectly smooth specular uses the reflection ray.\r\n                reflectDir = geomReflect(v.vector, normal);\r\n        \r\n                // rough (glossy) specular lerps from the smooth specular to the rough diffuse by the material roughness squared\r\n               // reflectDir = geomNormalize(geomMix(reflectDir, diffuseDir, {{ptMaterial.name}}.roughness * {{ptMaterial.name}}.roughness));\r\n                v.vector = reflectDir;\r\n            }\r\n        \r\n            if(rayType.refract){\r\n                    refractDir = geomRefract(v.vector,normal, r);\r\n                    // rough (glossy) specular lerps from the smooth specular to the rough diffuse by the material roughness squared\r\n                    refractDir = geomNormalize(geomMix(refractDir, diffuseDir, {{ptMaterial.name}}.roughness * {{ptMaterial.name}}.roughness));\r\n                    v.data.isInside = nextIsInside;\r\n                    v.data.currentAbsorb = nextAbsorb;\r\n                    v.data.currentEmission = nextEmission;\r\n                    v.data.currentOpticalDepth = nextOpticalDepth;\r\n                    v.vector = refractDir;\r\n            }\r\n            break;\r\n    \r\n    {{/scene.solids}}\r\n    }\r\n\r\n    v.data.lastBounceDist = 0.;\r\n    v.data.iBounce = v.data.iBounce + 1;\r\n    // be carefull, v is not normal to the surface\r\n    // if the time we flow is too small, we are still below the camera threshold\r\n    float t = 20. * camera.threshold / abs(geomDot(v.vector, normal));\r\n    v = flow(v, t);\r\n}\r\n\r\nvoid updateVectorData(inout ExtVector v, int hit, int objId){\r\n    if (hit == HIT_DEBUG) {\r\n        v.data.pixel = debugColor.rgb;\r\n        v.data.stop = true;\r\n        return;\r\n    }\r\n    if (hit == HIT_NOTHING) {\r\n        vec3 bgColor = {{scene.ptBackground.name}}.diffuse;\r\n        v.data.pixel = v.data.pixel + v.data.light * bgColor;\r\n        v.data.stop = true;\r\n        return;\r\n    }\r\n    if(hit == HIT_SOLID) {\r\n        updateVectorDataFromSolid(v, objId);\r\n        roulette(v);\r\n        return;\r\n    }\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    return gradient(");t.b(t.v(t.f("name",c,p,0)));t.b(",v);\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "RelVector {{name}}_gradient(RelVector v){\r\n    return gradient({{name}},v);\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    float newEp = 0.001;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    RelVector shiftPX = smallShift(v, vec3(newEp, 0, 0));\r");t.b("\n" + i);t.b("    RelVector shiftPY = smallShift(v, vec3(0, newEp, 0));\r");t.b("\n" + i);t.b("    RelVector shiftPZ = smallShift(v, vec3(0, 0, newEp));\r");t.b("\n" + i);t.b("    RelVector shiftMX = smallShift(v, vec3(-newEp, 0, 0));\r");t.b("\n" + i);t.b("    RelVector shiftMY = smallShift(v, vec3(0, -newEp, 0));\r");t.b("\n" + i);t.b("    RelVector shiftMZ = smallShift(v, vec3(0, 0, -newEp));\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    float vgx = ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftPX) - ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftMX);\r");t.b("\n" + i);t.b("    float vgy = ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftPY) - ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftMY);\r");t.b("\n" + i);t.b("    float vgz = ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftPZ) - ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(shiftMZ);\r");t.b("\n" + i);t.b("    RelVector n = createRelVector(v, vec3(vgx, vgy, vgz));\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    n = geomNormalize(n);\r");t.b("\n" + i);t.b("    return n;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "RelVector {{name}}_gradient(RelVector v){\r\n    float newEp = 0.001;\r\n\r\n    RelVector shiftPX = smallShift(v, vec3(newEp, 0, 0));\r\n    RelVector shiftPY = smallShift(v, vec3(0, newEp, 0));\r\n    RelVector shiftPZ = smallShift(v, vec3(0, 0, newEp));\r\n    RelVector shiftMX = smallShift(v, vec3(-newEp, 0, 0));\r\n    RelVector shiftMY = smallShift(v, vec3(0, -newEp, 0));\r\n    RelVector shiftMZ = smallShift(v, vec3(0, 0, -newEp));\r\n\r\n    float vgx = {{name}}_sdf(shiftPX) - {{name}}_sdf(shiftMX);\r\n    float vgy = {{name}}_sdf(shiftPY) - {{name}}_sdf(shiftMY);\r\n    float vgz = {{name}}_sdf(shiftPZ) - {{name}}_sdf(shiftMZ);\r\n    RelVector n = createRelVector(v, vec3(vgx, vgy, vgz));\r\n\r\n    n = geomNormalize(n);\r\n    return n;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v) {\r");t.b("\n" + i);t.b("    return sdf(");t.b(t.v(t.f("name",c,p,0)));t.b(",v);\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "float {{name}}_sdf(RelVector v) {\r\n    return sdf({{name}},v);\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec2 ");t.b(t.v(t.f("name",c,p,0)));t.b("_uvMap(RelVector v){\r");t.b("\n" + i);t.b("    return uvMap(");t.b(t.v(t.f("name",c,p,0)));t.b(", v);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec2 {{name}}_uvMap(RelVector v){\r\n    return uvMap({{name}}, v);\r\n}", H);return T.render.apply(T, arguments); };
...
module.exports = __webpack_require__.p + "img/953837709706027f7dc2.jpg";
...
module.exports = __webpack_require__.p + "img/26419cb1ce4138a11aa9.jpg";
...
module.exports = __webpack_require__.p + "img/eb3dc827520201070f7e.jpg";
...
module.exports = __webpack_require__.p + "img/ce3e4a6e1affece0e902.jpg";
...
module.exports = __webpack_require__.p + "img/370531b8ba6e5bd6a61e.jpg";
...
module.exports = __webpack_require__.p + "img/29989970ee70af555fd4.jpg";
...
module.exports = __webpack_require__.p + "img/bb733e02d9f86b8b7433.jpg";
...
module.exports = __webpack_require__.p + "img/f5196bbc22091948755e.jpg";
...
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/earth/earthmap2k.png
var earthmap2k = __webpack_require__(6896);
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/earth/Earth_NoClouds.jpg
var Earth_NoClouds = __webpack_require__(805);
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/moon/lroc_color_poles_2k.png
var lroc_color_poles_2k = __webpack_require__(2436);
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/moon/2k_moon.jpg
var _2k_moon = __webpack_require__(9882);
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/mars/2k_mars.jpg
var _2k_mars = __webpack_require__(5584);
// EXTERNAL MODULE: ./src/commons/materials/astronomy/img/sun/2k_sun.jpg
var _2k_sun = __webpack_require__(1115);
...
function marsTexture() {
    return new SimpleTextureMaterial(_2k_mars, {
        start: new external_three_namespaceObject.Vector2(-Math.PI, 0),
        scale: new external_three_namespaceObject.Vector2(1 / (2 * Math.PI), -1 / Math.PI),
    });
}
...
function sunTexture(textureID) {
    return new SimpleTextureMaterial(_2k_sun, {
        start: new external_three_namespaceObject.Vector2(-Math.PI, 0),
        scale: new external_three_namespaceObject.Vector2(1 / (2 * Math.PI), -1 / Math.PI),
    });
}

// EXTERNAL MODULE: ./src/commons/materials/woodBall/img/eye/eye_logo4.jpg
var eye_logo4 = __webpack_require__(251);
// EXTERNAL MODULE: ./src/commons/materials/woodBall/img/eye/eye_logo4_cedar.jpg
var eye_logo4_cedar = __webpack_require__(2703);
// EXTERNAL MODULE: ./src/commons/materials/woodBall/img/eye/eye_logo4_oak.jpg
        ...
        case "eye":
            switch (textureID) {
                case 0:
                    ...
                    break;
                case 1:
                    texture = eye_logo4_cedar;
                    break;
                case 2:
                    texture = eye_logo4_oak;
                    break;
                case 3:
                    texture = eye_logo5;
                    break;
