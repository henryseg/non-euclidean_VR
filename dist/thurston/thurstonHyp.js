...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v) {\r");t.b("\n" + i);t.b("    return vec3(0, float(v.data.iMarch/camera.maxSteps), v.data.totalDist / camera.maxDist);\r");t.b("\n" + i);t.b("    //return debugColor;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v) {\r\n    return vec3(0, float(v.data.iMarch/camera.maxSteps), v.data.totalDist / camera.maxDist);\r\n    //return debugColor;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    return normalMaterialRender(v, normal);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal) {\r\n    return normalMaterialRender(v, normal);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("        return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, RayType rayType) {\r\n    if (rayType.reflect){\r\n        return {{name}}.specular;\r\n    }\r\n    return {{material.name}}_render(v, normal);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r");t.b("\n" + i);t.b("    if (rayType.reflect){\r");t.b("\n" + i);t.b("      return ");t.b(t.v(t.f("name",c,p,0)));t.b(".specular;\r");t.b("\n" + i);t.b("    }\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, vec2 uv, RayType rayType) {\r\n    if (rayType.reflect){\r\n      return {{name}}.specular;\r\n    }\r\n    return {{material.name}}_render(v, uv);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal);\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,275,609,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return color;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n\r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, normal);\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n    \r\n    return color;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, normal, uv);\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,288,622,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n\r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, normal, uv);\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, RelVector normal, vec2 uv) {\r");t.b("\n" + i);t.b("    bool check;\r");t.b("\n" + i);t.b("    RelVector dir;\r");t.b("\n" + i);t.b("    float intensity;\r");t.b("\n" + i);t.b("    int k;\r");t.b("\n" + i);t.b(" \r");t.b("\n" + i);t.b("    PhongWrapMaterial material = ");t.b(t.v(t.f("name",c,p,0)));t.b(";\r");t.b("\n" + i);t.b("    vec3 baseColor = ");t.b(t.v(t.d("material.name",c,p,0)));t.b("_render(v, uv);\r");t.b("\n" + i);t.b("    vec3 color = vec3(0);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.f("lights",c,p,1),c,p,0,281,615,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        k = ");t.b(t.v(t.f("name",c,p,0)));t.b(".maxDirs;\r");t.b("\n" + i);t.b("        for(int j=0; j < k; j++){\r");t.b("\n" + i);t.b("            check = ");t.b(t.v(t.f("name",c,p,0)));t.b("_directions(v.vector, j, dir, intensity);\r");t.b("\n" + i);t.b("            if(check) {\r");t.b("\n" + i);t.b("                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, ");t.b(t.v(t.f("name",c,p,0)));t.b(".color, intensity);\r");t.b("\n" + i);t.b("            }\r");t.b("\n" + i);t.b("        }\r");t.b("\n" + i);});c.pop();}t.b("    \r");t.b("\n" + i);t.b("    return color;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, RelVector normal, vec2 uv) {\r\n    bool check;\r\n    RelVector dir;\r\n    float intensity;\r\n    int k;\r\n \r\n    PhongWrapMaterial material = {{name}};\r\n    vec3 baseColor = {{material.name}}_render(v, uv);\r\n    vec3 color = vec3(0);\r\n\r\n    {{#lights}}\r\n        k = {{name}}.maxDirs;\r\n        for(int j=0; j < k; j++){\r\n            check = {{name}}_directions(v.vector, j, dir, intensity);\r\n            if(check) {\r\n                color = color + lightComputation(v.vector.local, normal.local, dir.local, baseColor, material, {{name}}.color, intensity);\r\n            }\r\n        }\r\n    {{/lights}}\r\n    \r\n    return color;\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("vec3 ");t.b(t.v(t.f("name",c,p,0)));t.b("_render(ExtVector v, vec2 uv) {\r");t.b("\n" + i);t.b("    return render(");t.b(t.v(t.f("name",c,p,0)));t.b(", v, uv);\r");t.b("\n" + i);t.b("}\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "vec3 {{name}}_render(ExtVector v, vec2 uv) {\r\n    return render({{name}}, v, uv);\r\n}\r\n", H);return T.render.apply(T, arguments); };
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Zr": () => (/* reexport */ ResetSnapVRControls),
...
;// CONCATENATED MODULE: ./src/controls/vr/ResetSnapVRControls.js
...
const ResetSnapVRControls_RESET_CALLED = 1;
const ResetSnapVRControls_RESET_WAIT = 0;

class ResetSnapVRControls {
    ...
    constructor(position, controller, alignFacing = false, snap = false, camera = undefined) {
        ...
        this._reset = ResetSnapVRControls_RESET_WAIT;
        this._alignFacing = alignFacing;
        this._snap = snap;
        this._camera = camera;
        if (this._alignFacing && camera === undefined) {
     ...
     */
    onSelectStart() {
        this._reset = ResetSnapVRControls_RESET_CALLED;
    }
     ...
     */
    update() {
        if (this._reset === ResetSnapVRControls_RESET_CALLED) {
            this.position.reset();
            if (this._alignFacing) {
                const matrix = this._camera.threeCamera.matrixWorld;
                this.position.local.quaternion.setFromRotationMatrix(matrix);
...
// EXTERNAL MODULE: ./src/geometries/hyp/material/noisColor/shaders/struct.glsl
var noisColor_shaders_struct = __webpack_require__(8535);
var noisColor_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(noisColor_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/hyp/material/noisColor/NoiseColorMaterial.js
...
class NoiseColorMaterial extends Material {
    ...
    static glslClass() {
        return (noisColor_shaders_struct_default());
    }
...
var __webpack_exports__ResetSnapVRControls = __webpack_exports__.Zr;
