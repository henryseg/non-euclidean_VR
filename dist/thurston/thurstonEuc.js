...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b("* Gradient for the complement of a shape\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("RelVector ");t.b(t.v(t.f("name",c,p,0)));t.b("_gradient(RelVector v){\r");t.b("\n" + i);t.b("    RelVector gradient = ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_gradient(v);\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("    float x = v.local.pos.coords.x;\r");t.b("\n" + i);t.b("    float y = v.local.pos.coords.y;\r");t.b("\n" + i);t.b("    float z = v.local.pos.coords.z;\r");t.b("\n" + i);t.b("    vec4 dir = 0.05 * 30. * vec4(\r");t.b("\n" + i);t.b("    cos(30. * x) * sin(30. * y) * sin(30. * z),\r");t.b("\n" + i);t.b("    sin(30. * x) * cos(30. * y) * sin(30. * z),\r");t.b("\n" + i);t.b("    sin(30. * x) * sin(30. * y) * cos(30. * z),\r");t.b("\n" + i);t.b("    0\r");t.b("\n" + i);t.b("    );\r");t.b("\n" + i);t.b("    Vector local = Vector(v.local.pos, dir);\r");t.b("\n" + i);t.b("    RelVector disp = RelVector(local, v.cellBoost, v.invCellBoost);\r");t.b("\n" + i);t.b("    RelVector res = add(gradient, disp);\r");t.b("\n" + i);t.b("    return geomNormalize(res);\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n* Gradient for the complement of a shape\r\n*/\r\nRelVector {{name}}_gradient(RelVector v){\r\n    RelVector gradient = {{shape.name}}_gradient(v);\r\n\r\n    float x = v.local.pos.coords.x;\r\n    float y = v.local.pos.coords.y;\r\n    float z = v.local.pos.coords.z;\r\n    vec4 dir = 0.05 * 30. * vec4(\r\n    cos(30. * x) * sin(30. * y) * sin(30. * z),\r\n    sin(30. * x) * cos(30. * y) * sin(30. * z),\r\n    sin(30. * x) * sin(30. * y) * cos(30. * z),\r\n    0\r\n    );\r\n    Vector local = Vector(v.local.pos, dir);\r\n    RelVector disp = RelVector(local, v.cellBoost, v.invCellBoost);\r\n    RelVector res = add(gradient, disp);\r\n    return geomNormalize(res);\r\n}", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(5485);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("/**\r");t.b("\n" + i);t.b("* SDF for the displacement of a shape\r");t.b("\n" + i);t.b("*/\r");t.b("\n" + i);t.b("float ");t.b(t.v(t.f("name",c,p,0)));t.b("_sdf(RelVector v){\r");t.b("\n" + i);t.b("    \r");t.b("\n" + i);t.b("    float x = v.local.pos.coords.x;\r");t.b("\n" + i);t.b("    float y = v.local.pos.coords.y;\r");t.b("\n" + i);t.b("    float z = v.local.pos.coords.z;\r");t.b("\n" + i);t.b("    float disp = 0.05 * sin(30. * x) * sin(30. * y) * sin(30. * z);\r");t.b("\n" + i);t.b("    return ");t.b(t.v(t.d("shape.name",c,p,0)));t.b("_sdf(v) + disp;\r");t.b("\n" + i);t.b("}");return t.fl(); },partials: {}, subs: {  }}, "/**\r\n* SDF for the displacement of a shape\r\n*/\r\nfloat {{name}}_sdf(RelVector v){\r\n    \r\n    float x = v.local.pos.coords.x;\r\n    float y = v.local.pos.coords.y;\r\n    float z = v.local.pos.coords.z;\r\n    float disp = 0.05 * sin(30. * x) * sin(30. * y) * sin(30. * z);\r\n    return {{shape.name}}_sdf(v) + disp;\r\n}", H);return T.render.apply(T, arguments); };
