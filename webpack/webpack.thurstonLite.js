...
module.exports = merge(common, {
    ...
    entry: {
        "thurstonLite": './src/thurston/thurstonLite/ThurstonLite.js',
    },
    output: {
        // clean: true,
    ...
    plugins: [
        ...
        new FileManagerPlugin({
            events: {
                onEnd: {
                    copy: [{
                        source: 'dist/3ds/thurstonLite.js',
                        destination: path.resolve(__dirname, '../examples/library/3ds/thurstonLite.js')
                    }],
                },
            }
        }),
