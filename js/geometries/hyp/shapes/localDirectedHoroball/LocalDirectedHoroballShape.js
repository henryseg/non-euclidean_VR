...
import {Quaternion, Vector3, Vector4} from "../../../../lib/threejs/build/three.module.js";
 ...
 * The SDF is a directed SDF when the point is inside the horoball.
 * Does not seem to make a huge difference,
 * when rendering cusps as the complement of a horoball (assuming that the creeping is off !)
 */
export class LocalDirectedHoroballShape extends BasicShape {
    ...
    constructor(location, offset) {
        ...
        if (location.isIsometry) {
            ...
            throw new Error("LocalDirectedHoroballShape: this type of location is not implemented");
        }
        super(isom);
        this.addImport();
        /**
    ...
    get uniformType() {
        return 'LocalDirectedHoroballShape';
    }
