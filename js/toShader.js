...
function updateMaterial() {
    ...
    globals.material.uniforms.localLightPosition.value = ORIGIN.clone().translateBy(new Isometry().translateByVector(new Vector4(0.2 * Math.sin(2. * T), 0.2 * Math.cos(2. * T), 0.2 * Math.sin(2. * T))));
