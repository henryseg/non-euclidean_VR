...
function updateMaterial() {
    ...
    globals.material.uniforms.localLightPosition.value = [
        ORIGIN.clone().translateBy(new Isometry().translateByVector(new Vector4(PI / 5. * Math.sin(T), PI / 3. * Math.cos(T / 2.), 2))),

            ORIGIN.clone(),
       // .translateBy(new Isometry().translateByVector(new Vector4(-PI / 3. * Math.sin(T / 2), PI / 3. * Math.cos(T), 2)))

            ORIGIN.clone().translateBy(new Isometry().translateByVector(new Vector4(-PI / 4. * Math.cos(T / 2), PI / 3. * Math.sin(T), 2))),

            ORIGIN.clone().translateBy(new Isometry().translateByVector(new Vector4(PI / 3. * Math.sin(T / 2), PI / 5. * Math.cos(T), 2)))
        ];
