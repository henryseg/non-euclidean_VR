...
var initObjects = function () {
    PointLightObject(new THREE.Vector3(2 * cubeHalfWidth, 0, 0), new THREE.Vector4(68 / 256, 197 / 256, 203 / 256, 1));
    PointLightObject(new THREE.Vector3(0, 2 * cubeHalfWidth, 0), new THREE.Vector4(252 / 256, 227 / 256, 21 / 256, 1));
    PointLightObject(new THREE.Vector3(0, 0, 2 * cubeHalfWidth), new THREE.Vector4(245 / 256, 61 / 256, 82 / 256, 1));
    PointLightObject(new THREE.Vector3(-2 * cubeHalfWidth, -1.5 * cubeHalfWidth, -2 * cubeHalfWidth), new THREE.Vector4(238 / 256, 142 / 256, 226 / 256, 1));
